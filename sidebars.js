        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        'secure-connections/sauce-connect-4',
                        'secure-connections/sauce-connect-4/lifecycle',
                        'secure-connections/sauce-connect-4/installation',
                        'secure-connections/sauce-connect-4/quickstart',
...

                        {
                            ...
                            collapsed: true,
                            items: [
                                'secure-connections/sauce-connect-4/setup-configuration/basic-setup',
                                'secure-connections/sauce-connect-4/setup-configuration/yaml-config',
                                'secure-connections/sauce-connect-4/setup-configuration/environment-variables',
                                'secure-connections/sauce-connect-4/setup-configuration/high-availability',
                                'secure-connections/sauce-connect-4/setup-configuration/additional-proxies',
                                'secure-connections/sauce-connect-4/setup-configuration/specialized-environments',
                                'secure-connections/sauce-connect-4/setup-configuration/docker',
                                'secure-connections/sauce-connect-4/setup-configuration/readiness-checks',
                            ],
                        },
                        'secure-connections/sauce-connect-4/proxy-tunnels',
                        'secure-connections/sauce-connect-4/security-authentication',
                        {
                            type: 'category',
                            label: 'Advanced',
                            collapsed: true,
                            items: [
                                'secure-connections/sauce-connect-4/advanced/architecture',
                                'secure-connections/sauce-connect-4/advanced/kgp',
                                'secure-connections/sauce-connect-4/advanced/specifications',
                            ],
                        },
                        'secure-connections/sauce-connect-4/troubleshooting',
                        'secure-connections/sauce-connect-4/faq',
                    ],
                },
            ...
            items: [
                {
                    ...
                    collapsed: true,
                    items: [
                        'app-distribution/general/getting-started',
                        'app-distribution/general/installing-apps',
                    ],
                },
                {
                    type: 'category',
                    ...
                    collapsed: true,
                    items: [
                        'app-distribution/projects/uploading-builds',
                        'app-distribution/projects/landing-pages',
                        'app-distribution/projects/build-lifecycle',
                        'app-distribution/projects/closed-beta',
                    ],
                },
                {
                    type: 'category',
                    ...
                    collapsed: true,
                    items: [
                        'app-distribution/organization/managing-teams',
                        'app-distribution/organization/tester-groups',
                        'app-distribution/organization/members-roles',
                        'app-distribution/organization/notifications',
                        'app-distribution/organization/audit-log',
                    ],
                },
                {
                    type: 'category',
                    ...
                    collapsed: true,
                    items: [
                        'app-distribution/settings/my-profile',
                        'app-distribution/settings/organization',
                        'app-distribution/settings/sso-saml',
                        'app-distribution/settings/oidc-authentication',
                    ],
                },
                {
                    type: 'category',
                    ...
                    collapsed: true,
                    items: [
                        'app-distribution/integrations/saucelabs-connection',
                        'app-distribution/integrations/webhooks',
                        'app-distribution/integrations/smtp-email',
                        'app-distribution/integrations/custom-storage',
                        'app-distribution/integrations/google-play',
                        'app-distribution/integrations/apple-app-store',
                    ],
                },
                {
                    type: 'category',
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        .sort()
                        .map((el) => `visual-testing/integrations/${el}`),
                },
                'visual-testing/cli',
