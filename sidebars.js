            ...
            items: [
                {
                    ...
                    collapsed: true,
                    items: [
                        'test-fairy/using-test-fairy/uploading-an-app',
                        'test-fairy/using-test-fairy/builds',
                        'test-fairy/using-test-fairy/dashboard',
                        'test-fairy/using-test-fairy/insights',
                    ],
                },
                {
                    type: 'category',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            collapsed: true,
                            items: [
                                'test-fairy/sdk/ios/ad-hoc-ipa',
                                'test-fairy/sdk/ios/adding-udids',
                                'test-fairy/sdk/ios/custom-ent-apps',
                                'test-fairy/sdk/ios/dsyms',
                        ...
                        'test-fairy/sdk/logging',
                        'test-fairy/sdk/tf-production',
                        'test-fairy/sdk/crash-handler-testing',
                        'test-fairy/sdk/identifying-users',
                        'test-fairy/sdk/remote-logging',
                        'test-fairy/sdk/session-attributes',
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        'test-fairy/app-distribution/managing-dist',
                        'test-fairy/app-distribution/app-versioning',
                        'test-fairy/app-distribution/landing-pages',
                    ...
                    items: [
                        {
                            ...
                            collapsed: true,
                            items: [
                                'test-fairy/testing-an-app/testers/building-testers-app',
                                'test-fairy/testing-an-app/testers/testing-android-apps',
                                'test-fairy/testing-an-app/testers/managing-testers',
                        ...
                        },
                        {
                            ...
                            collapsed: true,
                            items: [
                                'test-fairy/testing-an-app/using-bug-tracking',
                                'test-fairy/testing-an-app/bug-tracking/github',
                                'test-fairy/testing-an-app/bug-tracking/jira-cloud',
                                'test-fairy/testing-an-app/bug-tracking/jira-server',
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        'test-fairy/platforms/cordova',
                        'test-fairy/platforms/expo',
                        'test-fairy/platforms/flutter',
                        'test-fairy/platforms/ionic',
                        'test-fairy/platforms/lumberyard',
                        'test-fairy/platforms/nativescript',
                        'test-fairy/platforms/neptune',
                        'test-fairy/platforms/react-native',
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        'test-fairy/integrations/centercode',
                        'test-fairy/integrations/coralogix',
                        'test-fairy/integrations/slack',
                        'test-fairy/integrations/smtp-gmail',
                        'test-fairy/integrations/splunk',
                        'test-fairy/integrations/zendesk',
                        'test-fairy/integrations/intercom',
                        'test-fairy/integrations/ms-teams',
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        'test-fairy/ci-tools/bamboo',
                        'test-fairy/ci-tools/bitbucket',
                        'test-fairy/ci-tools/circle-ci',
                        'test-fairy/ci-tools/gitlab',
                        'test-fairy/ci-tools/ms-app-ctr',
                        'test-fairy/ci-tools/team-city',
                        'test-fairy/ci-tools/vs-team',
                    ],
                },
                {
                    type: 'category',
