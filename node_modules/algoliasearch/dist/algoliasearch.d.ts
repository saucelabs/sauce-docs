...
export declare type SearchIndex = SearchIndex_2 & {
    ...
    readonly findAnswers: (query: string, queryLanguages: readonly string[], requestOptions?: RequestOptions & FindAnswersOptions) => Readonly<Promise<FindAnswersResponse>>;
