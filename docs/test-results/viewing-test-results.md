...
2. On the **Test Results** page, select **Virtual Devices** or **Real Devices** from the dropdown list.
...
| Filter         | Description                                                                                                                                                                                |
| :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Search by name | Filter tests results by name                                                                                                                                                               |
| Device Type    | Filter tests results by: <ul><li>Virtual Devices</li><li>Real Devices</li></ul>                                                                                                            |
| Time Range     | Filter tests results by: <ul><li>Today</li><li>Last 7 days</li><li>Last 14 days</li><li>Last 30 days</li><li>All Time</li></ul>                                                            |
| Owner          | Filter tests results by: <ul><li>Tests that you have run</li><li>All the tests for your organization</li><li>Tests run by one of your selected sub-accounts</li></ul>                      |
...
| Browser        | Filter tests results by broswer (Only for Virtual Devices)                                                                                                                                 |
| Device         | Filter tests results by tests that ran on a specific device                                                                                                                                |
...
2. On the **Builds** page, select **Virtual Cloud** or **Real Devices** to view the relevant device results.
...
2. On the **Archive** page, select **Virtual Cloud** or **Real Devices** to view the relevant device results.
...
1. Tick the test or build result you want to delete. You can also select multiple test or build results for deletion.
...
3. In the confimation dialog, click **Delete**.
