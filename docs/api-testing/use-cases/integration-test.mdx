...
<img
    src={useBaseUrl('/img/api-testing/int-test-endpoints.png')}
    alt='Testing interactions between endpoints'
    width='600'
/>
...
7. Test the response payload for the endpoint.
    ...
    <img
        src={useBaseUrl('/img/api-testing/int-test-response-payload.webp')}
        alt='Testing the response payload'
    />
