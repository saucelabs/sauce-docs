...
<img
    src={useBaseUrl('img/api-testing/ioComponents.png')}
    alt='I/O Components'
/>
<img
    src={useBaseUrl('img/api-testing/ioComponents1.png')}
    alt='I/O Components'
/>
...
<img
    src={useBaseUrl('img/api-testing/githubComponent.webp')}
    alt='GitHub Component'
/>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    The repository branch that the desired version of the data
                    file is in.
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The variable that the payload will be stored under.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <p>The name of the file in the repository.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <p>
                    <small>
                        | REQUIRED | 'json', 'xml', 'html', 'text', 'csv' |
                    </small>
                </p>
                <p>The filetype of the file in the repository.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The open API file from the Vault Drive.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <p>The operationId you want to use in your test.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <p>
                    <small>| REQUIRED | INTEGER |</small>
                </p>
                <p>The status code you want to test.</p>
            </td>
        </tr>
        <tr>
            <td>
                <strong>Inclusion Strategy </strong>
            </td>
            <td>
                <p>
                    <small>| REQUIRED | 'Required', 'All' |</small>
                </p>
                <p>
                    <code>Required</code> will consider only the required
                    fields. <code>All</code> will consider all the fields.
                </p>
            </td>
        </tr>
    </tbody>
...
<img
    src={useBaseUrl('img/api-testing/CT_child.png')}
    alt='Include and Exclude Components'
/>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The name of the field you want to include/exclude.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <p>
                    The place where the variable should be present (i.e.
                    header|query).
                </p>
            </td>
        </tr>
...
<img
    src={useBaseUrl('img/api-testing/filedatasource.png')}
    alt='File Data Source'
/>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The variable name you want to assign.</p>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The file you selected as the data source.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <p>
                    <small>
                        | REQUIRED | 'application/json', 'text/plain',
                        'application/x-www-form-urlencoded', 'text/xml'|
                    </small>
                </p>
                <p>The Content-Type for the body.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <p>
                    <small>| REQUIRED | STRING or VARIABLE |</small>
                </p>
                <p>The Body you want to send with the request.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The key you want to send in your request as Header.</p>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    The key you want to send in your request as an URL Encoded
                    Param.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    The key you want to send in your request as a Query Param.
                </p>
            </td>
        </tr>
        <tr>
...
<img
    src={useBaseUrl('img/api-testing/metrics-improve-config.png')}
    alt='Reconfiguring a footprint'
    width='600'
/>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The value for the configuration component.</p>
            </td>
        </tr>
    </tbody>
</table>
...
<img
    src={useBaseUrl('/img/api-testing/config_timeout.png')}
    alt='Configuring the timeout'
    width='600'
/>
...
<table id='table-api'>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <p>
                    <small>| REQUIRED | NUMBER |</small>
                </p>
                <p>It sets up the seconds you want the request to timed out.</p>
            </td>
        </tr>
    </tbody>
</table>
...
<img
    src={useBaseUrl('/img/api-testing/follow_redirect_false.png')}
    alt='Configuring the redirect'
    width='600'
/>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>It must be `follow_redirects`.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <p>
                    <small>| REQUIRED | 'true' (default), 'false' |</small>
                </p>
                <p>
                    If 'true' the request will follow the redirect, if 'false'
                    the request will not follow the redirect
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The name of the variable in the I/O request.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <p>The file from the Vault Drive.</p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <p>The name you want to assign to the file.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>The password required for authentication.</p>
            </td>
        </tr>
    </tbody>
</table>
