...
<img
    src={useBaseUrl('img/api-testing/logicalComponents.png')}
    alt='Logical Components'
/>
        ...
        <tr>
            ...
            <td>
                <p>
                    <small>
                        | REQUIRED |{' '}
                        <a href='/api-testing/composer/expressions/#using-expressions'>
                            EXPRESSION
                        </a>{' '}
                        |
                    </small>
                </p>
                <p>The path of the collection you want to iterate on.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    The condition that has to be met for the assertions block to
                    be executed.
                </p>
            </td>
        </tr>
