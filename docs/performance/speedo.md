...
|`firstMeaningfulPaint`|<button class="badge-red">DEPRECATED</button> The amount of time it takes for a page's primary body of content to rendeR. This metric is replaced by `largestContentfulPaint`.|seconds|
