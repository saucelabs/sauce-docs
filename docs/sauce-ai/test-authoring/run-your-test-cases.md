...
| :---: | ----- | ----- |
| **1** | **Platform** | Select the operating system or platform on which you want to execute the test, such as **Windows**, **macOS**, **Android**, or **iOS**. |
...
| **3** | **Screen Resolution** | Select the required screen resolution to execute the test under a specific display configuration. |
