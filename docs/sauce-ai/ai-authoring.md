...
| **Data Variables** | Store reusable values such as usernames, passwords, and URLs as variables and reference them in prompts with `{{variable_name}}` syntax, both in the UI and through the API. | **[See more](/docs/sauce-ai/test-authoring/data-variables.md)** |
