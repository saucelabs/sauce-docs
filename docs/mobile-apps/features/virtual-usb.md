...
1. Click below to download the latest Virtual USB client to your local machine where you have your IDE installed/set up.
  ...
  <p> <a href="https://saucelabs-vusb.s3.eu-west-1.amazonaws.com/v2.0.3/virtual-usb-client-2.0.3.jar"><button class="download">Download Virtual USB 2.0.1</button></a> </p>
