...
:::note
This feature CANNOT be used as Appium Inspector. If you want to use Appium Inspector with Sauce, please visit the following link: https://github.com/saucelabs/appium-inspector-saucelabs
