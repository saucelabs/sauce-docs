...
If you upload an app that is signed with an enterprise certificate, and **Instrumentation** is enabled in app settings, you must manually trust the certificate before it will successfully launch.
