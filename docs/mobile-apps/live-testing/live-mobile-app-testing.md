...
## Selecting an App
### from App Management
On the main **App Management** page, you can select an app to test by clicking **Start Test** in the row of the desired app group. The app build chosen will be the most recently uploaded build within that group. The device selection page will open, with the option to test on a real device or a virtual device.
