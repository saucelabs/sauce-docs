...
App groups can be shared across teams within an organization, but only organization admins and team admins have the permission to share an app group with other teams.
