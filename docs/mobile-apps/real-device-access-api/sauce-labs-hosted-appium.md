...
You can find the full code sample [below](sauce-labs-hosted-appium.md#how-it-looks-in-practice). Endpoint names align with the [Real Device Access API Reference](/real-device-access-api) under the `Session Lifecycle` and `Appium Server` tags.
