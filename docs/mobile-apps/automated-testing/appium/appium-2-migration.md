...
| -------- | -------------------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Android  | [UiAutomator2](https://github.com/appium/appium-uiautomator2-driver) | <span className="sauceDBlue">Virtual and Real Devices</span> | <span className="sauceDBlue">Virtual and Real Devices</span> |
| Android  | [Flutter](https://github.com/appium-userland/appium-flutter-driver)  | <span className="sauceDBlue">Virtual and Real Devices</span> | <span className="sauceDBlue">Virtual and Real Devices</span> |
| Android  | [Espresso\*](https://github.com/appium/appium-espresso-driver)       | -                                                            | <span className="sauceDBlue">Android Emulators</span>        |
| iOS      | [XCUITest](https://github.com/appium/appium-xcuitest-driver)         | <span className="sauceDBlue">Virtual and Real Devices</span> | <span className="sauceDBlue">Virtual and Real Devices</span> |
| iOS      | [Flutter](https://github.com/appium-userland/appium-flutter-driver)  | <span className="sauceDBlue">Virtual and Real Devices</span> | <span className="sauceDBlue">Virtual and Real Devices</span> |
