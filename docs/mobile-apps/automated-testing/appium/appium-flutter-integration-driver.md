...
capabilities.setCapability("appium:deviceName", "Google Pixel Emulator");
// Mandatory for using the appium-flutter-integration-driver
...
sauceOptions.put("appiumVersion", "appium2-20240701");
...
capabilities.AddAdditionalCapability("appium:deviceName", "Google Pixel Emulator");
// Mandatory for using the appium-flutter-integration-driver
...
sauceOptions.Add("appiumVersion", "appium2-20240701");
