...
The directory path to the application. The default directory is `{project-root}/apps/filename.ipa`, and the property supports expanded environment variables to designate the path, as shown in the following examples.
...
The directory path to the testing application. The default directory is `{project-root}/apps/testfile.app`, and the property supports expanded environment variables to designate the path, as shown in the following examples.
