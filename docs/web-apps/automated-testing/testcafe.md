...
*macOS 14+ requires Premium subsubscription and `armRequired:"true"` as an additional configuration parameter in your [YAML file](/web-apps/automated-testing/testcafe/yaml#example-configuration)
