...
Your script can be stored in GitHub or in [App Storage](/mobile-apps/app-storage/). You can also use [Gist](https://gist.github.com/) to easily host your executable file. Make sure to use the link containing the raw file contents.
