...
:::warning
This feature has been deprecated. We recommend configuring your reporters with your cypress config file. See the [cypress documentation](https://docs.cypress.io/guides/tooling/reporters) for details.
:::
