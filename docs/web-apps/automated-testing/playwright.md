...
* [Incorporate saucectl in your pipeline](/dev/cli/saucectl/usage/integrations/): Playwright on Sauce supports CI integrations with Cirlce CI, GitLab, Jenkins, and GitHub Actions.
