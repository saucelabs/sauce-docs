...
:::note 
To learn more about the Ionic applications, see the [Ionic](/test-fairy/platforms/ionic) documentation.
:::
...
We recommended logging error events to TestFairy. It displays the exceptions and the rest of the session data, including logs and attributes. For more information, see the [Exception Logging](/test-fairy/sdk/logging#cordova) document.
