...
<details>
<summary><span className="api get">GET</span> <code>/v1/ai-authoring/testcases/&#123;id&#125;/runs</code></summary>

Returns a paginated list of runs for a specific test case.
...
<table id="table-api">
  ...
  <tbody>
    <tr>
     <td><code>startDate</code></td>
     <td><p><small>| QUERY | OPTIONAL | DATE |</small></p><p>ISO 8601 start date filter — only returns runs created on or after this date</p></td>
    </tr>
  </tbody>
  <tbody>
    <tr>
  ...
  <tbody>
    <tr>
     <td><code>userId</code></td>
     <td><p><small>| QUERY | OPTIONAL | STRING |</small></p><p>Filter runs by the UUID of the user who initiated them</p></td>
    </tr>
  </tbody>
  <tbody>
    <tr>
     <td><code>teamId</code></td>
     <td><p><small>| QUERY | OPTIONAL | STRING |</small></p><p>Filter runs by team UUID</p></td>
    </tr>
  </tbody>
  <tbody>
    <tr>
     <td><code>testCaseId</code></td>
     <td><p><small>| QUERY | OPTIONAL | STRING |</small></p><p>Filter runs by test case Id</p></td>
    </tr>
  </tbody>
  <tbody>
    <tr>
...
```jsx title="Sample Request"
curl -u "$SAUCE_USERNAME:$SAUCE_ACCESS_KEY" --location \
--request GET "https://api.us-west-1.saucelabs.com/v1/ai-authoring/testcases/<id>/runs" | json_pp
```
...
```jsx title="Sample Request"
curl -u "$SAUCE_USERNAME:$SAUCE_ACCESS_KEY" --location \
--request GET "https://api.eu-central-1.saucelabs.com/v1/ai-authoring/testcases/<id>/runs" | json_pp
```
</TabItem>
</Tabs>
...
<tbody>
  <tr>
    <td><code>200</code></td>
    <td colSpan='2'>Success. Returns a paginated list of test case runs</td>
  </tr>
</tbody>
<tbody>
  <tr>
    ...
    <ul>
      <li>Invalid path parameters</li>
      <li>Invalid query string parameters</li>
    </ul>
    </td>
  </tr>
</tbody>
...
```jsx title="Sample Response"
{
   "data" : {
      "items" : [
         {
            "build" : "Saucedemo - Login test - 1",
            "creationDate" : "2026-03-12T07:09:29.372Z",
            "id" : "<id>",
            "jobs" : [
               { ... }
            ],
