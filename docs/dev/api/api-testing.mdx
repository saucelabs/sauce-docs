...
<table id='table-api'>
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| PATH | REQUIRED | STRING |</small>
                </p>
                <p>
                    Your project's hook ID, which you can create and/or retrieve
                    from your project's <strong>Webhooks</strong> tab.
                </p>
            </td>
        </tr>
    </tbody>
...
<table id='table-api'>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    The name of a test. If it's the same as an existing one, it
                    will be overwritten.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Description for your Test. This parameter is required,
                    however, the field can be left empty.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| BODY | OPTIONAL | ARRAY |</small>
                </p>
                <p>The set of distinguishing tags for your Test.</p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    The input of your API Test. You can obtain this by going
                    into a Test > <strong>Compose</strong> section > toggle{' '}
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Must contain the unit of the test you want to upload to the
                    cloud. You can obtain this by going into a Test >{' '}
                    <strong>Compose </strong>section > toggle{' '}
                    <strong>Code View</strong>.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    The test ID. To find it, go to your project >{' '}
                    <strong>Tests</strong> tab > Hover over your test and click{' '}
                    <strong>Edit</strong> > Grab the test ID from your browser's
                    URL (
                    <code>
                        https://app.saucelabs.com/api-testing/project/&#123;projectId&#125;/test/
                        <strong>&#123;testId&#125;</strong>/compose
                    </code>
                    ).
                </p>
            </td>
...
<table id='table-api'>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    If this execution is associated with a build, provide the
                    build ID so that all resources can be associated to it.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Specifies your tunnel ID for running tests using{' '}
                    <strong>Sauce Connect Proxy.</strong>
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Specifies your tunnel owner for running tests using{' '}
                    <strong>
                        Sauce Connect Proxy. It is recommended when using
                        unnamed tunnels.
                    </strong>
                </p>
            </td>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| BODY | OPTIONAL | OBJECT |</small>
                </p>
                <p>
                    Specifies the environment variables you want to use in your
                    test as key-value pairs.{' '}
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    A test tag, which you can find in your project's{' '}
                    <strong>Tests</strong> tab.
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    The input section of your test in the same format as in Test
                    > <strong>Compose</strong> section > <strong>Input</strong>{' '}
                    section > toggle <strong>Code View</strong>.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Must contain the unit of the test you want to execute in the
                    same format as in Test > <strong>Compose</strong> section >
                    toggle <strong>Code View</strong>.
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Specified the data format returned. Available values are{' '}
                    <code>json</code> and <code>junit</code>. The default value
                    is <code>json</code>
                </p>
            </td>
        </tr>
                                ...
                                'events': [
                                    {
                                        ...
                                        'footprint':
                                            'dog.ceo/api/breed/retriever/list',
                                        'metrics': {
                                            'fetch': 1,
                                            'latency': 322,
                                            'overall': 338,
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Specifies the data format returned. Available values are{' '}
                    <code>json</code> and <code>junit</code>. The default value
                    is <code>json</code>
                </p>
            </td>
                                            ...
                                            'payload_response': {
                                                'headers': [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        'value':
                                                            'adc111d8b5cc4dde89f64ebca253e1aa',
                                                    },
                                                    {
                                            ...
                                            'payload_response': {
                                                'headers': [
                                                    ...
                                                    },
                                                    {
                                                        'name': 'x-sl-request-id',
                                                        'value':
                                                            'adc111d8a5cc4dde89f64ebca253e1aa',
                                                    },
                                                    {
                                                        'name': 'x-envoy-upstream-service-time',
                                                        'value': '90',
                                            ...
                                            'payload_response': {
                                                'headers': [
                                                    ...
                                                    },
                                                    {
                                                        'name': 'x-sl-request-id',
                                                        'value':
                                                            'adc211d8a5cc4dde89f64ebca253e1aa',
                                                    },
                                                    {
                                                        'name': 'x-envoy-upstream-service-time',
                                                        'value': '90',
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>The buildId you want to create or update.</p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| BODY | OPTIONAL | STRING |</small>
                </p>
                <p>The environment you want to assign the build to.</p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>The branch the build belongs to.</p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>The issue the build belongs to.</p>
            </td>
        </tr>
    </tbody>
</table>
...
<table id='table-api'>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| QUERY | OPTIONAL | INTEGER |</small>
                </p>
                <p>
                    Identifies the start date, in <code>YYYY-MM-DD</code> (UTC)
                    format.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Identifies the end date, in <code>YYYY-MM-DD</code> (UTC)
                    format. The default value is current date.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Identifies the number of records to return. The default
                    value is 10 and the max value is 50.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Specifies the number of records to be skipped from the
                    beginning of the list. Must be used in combination with the
                    limit parameter.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>The build ID you want to retrieve the details.</p>
            </td>
        </tr>
    </tbody>
</table>
...
<table id='table-api'>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| BODY | REQUIRED | ARRAY |</small>
                </p>
                <p>
                    The array contains the variable object you want to
                    update/add to the project vault and it can be empty. Each
                    object contains the key/value pairs: <code>name</code> (the
                    name of the variable you want to update/add),{' '}
                    <code>value</code> (the value of the variable you want to
                    update/add), <code>type</code> the value can be{' '}
                    <code>variable</code> or <code>sensitive</code>. If the type
                    is <code>sensitive</code> the value is{' '}
                    <a href='/api-testing/vault/#mark-variables-as-sensitive'>
                        obfuscated
                    </a>{' '}
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <small>| BODY | REQUIRED | OBJECT |</small>
                </p>
                <p>
                    The object containing the snippets you want to update/add.
                    The object contains the key/value pairs:
                    snippet_name:snippet. It can be empty.
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Identifies the start time, in UNIX time milliseconds. The
                    default value is 2 days before.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Identifies the end time, in UNIX time milliseconds. The
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Identifies the number of records to return. The default
                    value is 100 and the max value is 500.
                </p>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    The ID of an event, that you can retrieve from the{' '}
                    <a href='#list-all-events'>List All Events</a> response
                    payload.
                </p>
            </td>
        </tr>
...
<table id='table-api'>
    ...
    <tbody>
        <tr>
            <td>
                <code>failuresOnly</code>
            </td>
            <td>
                <p>
                    <small>| QUERY | OPTIONAL | BOOLEAN |</small>
                </p>
                <p>
                    Filters the metrics to include only the tests that completed
                    with failure(s).
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>Filters the metrics based on the footprint.</p>
            </td>
        </tr>
    </tbody>
    <tbody>
