...
- Include our custom `sauce:options` W3C WebDriver-compliant capabilities in your Sauce Labs test scripts. See <a href="/dev/test-configuration-options">Test Configuration Options</a> for a complete list of `sauce:options` and guidance on which are required and optional.
