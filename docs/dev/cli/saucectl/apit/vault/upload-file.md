---
id: upload-file
title: saucectl apit vault upload-file
sidebar_label: upload-file
---

Uploads a file to a project's vault drive.
...
```bash
saucectl apit vault upload-file "filename" --project "project_name"
```
...
```bash
saucectl apit vault upload-file "filename" --region us-west-1
```
