...
**Description**: Sets your Sauce Labs [data center endpoint](/basics/data-center-endpoints/#data-center-endpoints) (for example, `us-west`, `eu-central`). Default: If you don't specify a data center, the default value is `us-west`.<br/>
...
<p><small>| OPTIONAL | STRING | <span className="sauceGreen">4.7.x</span>| </small></p>
...
<p><small>| OPTIONAL | BOOLEAN | <span className="sauceGreen">4.7.x</span>| </small></p>
