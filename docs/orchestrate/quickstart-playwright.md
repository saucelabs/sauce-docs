...
Sauce Orchestrate uses container technology to package and run your tests in the Sauce Labs cloud. See the [Getting Started > How it Works section](/docs/orchestrate/getting-started/#how-it-works) for more details.
