...
<img src={useBaseUrl('img/visual/e2e-quickstart-view-logs.png')} alt="Screener E2E Quickstart accept state" width="205" /><img src={useBaseUrl('img/visual/e2e-quickstart-view-on-sauce.png')} alt="Screener E2E Quickstart accept state" width="250" />
...
1. Adds your Sauce Labs credentials, test capabilities (e.g., project name), Screener E2E Testing commands.
2. Launches the [Sauce Labs demo website](http://saucedemo.com) in a browser and logs in.
3. Carries out a Screener E2E test session (i.e., taking UI snapshots).
4. Ends session.
...
Go your Screener Dashboard (Sauce Labs > **Screener** > **Log in to Screener**) to confirm that your test is running.
