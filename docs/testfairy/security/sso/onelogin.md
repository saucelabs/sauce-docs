...
1. Enter **Sauce Labs Mobile App Distribution** in the search box, and select the application.

1. Click **Save**.

1. Enter your Sauce Labs Mobile App Distribution subdomain (for example, acme) under the **Configuration** tab. Then, click **Save**.
