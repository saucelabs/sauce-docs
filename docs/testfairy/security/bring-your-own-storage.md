...
Sauce Mobile Sauce Labs Mobile App Distribution on a Private Cloud instance, allows you to *Bring Your Own Storage* and store the app artifacts on your own bucket.

This document explains how to create a new bucket that can be then used by Sauce Mobile Sauce Labs Mobile App Distribution.
...
- Paste this **Key Policy**:
  ```json
  {
    ...
    "Statement": [
      {
        "Sid": "Allow Sauce Mobile Sauce Labs Mobile App Distribution",
        "Effect": "Allow",
        "Principal": {
          "AWS": "<will be provided to you>"
        },
