...
- Access to the Sauce Labs Mobile App Distribution platform for managing testers.
- A list of testers' UDIDs obtained through the Sauce Labs Mobile App Distribution platform.
