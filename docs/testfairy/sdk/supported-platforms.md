...
Along with native Android and iOS development, Sauce Labs Mobile App Distribution supports a number of other platforms. See below for a list of each supported platform, and the supported features on each platform.
