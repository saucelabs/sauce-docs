...
1. Open the invitation email and follow the link to //register your mobile device in Sauce Labs Mobile App Distribution//.
...
4. You will be prompted to download the Sauce Labs Mobile App Distribution configuration profile. Click **Allow** button to download it.
5. Once the profile was downloaded go to the settings app and go to the **General** --> **Profiles** menu.
6. On the right side you will see a list of profiles with a section of Downloaded Profiles. Press the Sauce Labs Mobile App Distribution profile that is located there.
7. The profile installer will open. Click **Install**.
8. Your device is now registered in Sauce Labs Mobile App Distribution. Please wait for the developer to send you a download link.
...
1. Open your Sauce Labs Mobile App Distribution account via the link my.testfairy.com on the device you want to test.
