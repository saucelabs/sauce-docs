...
Connect your Sauce Labs Mobile App Distribution account to your Simple Mail Transfer Protocol (SMTP), G-suite Gmail service, or private Gmail account to increase deliverability and open rates of email messages sent to system users.
...
4. **Allow** Sauce Labs Mobile App Distribution access to the account:
