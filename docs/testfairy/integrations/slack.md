...
Sauce Labs Mobile App Distribution integrates with Slack seamlessly, providing human-readable, real-time notifications for your selected events.

1. Head over to your Sauce Labs Mobile App Distribution Dashboard, and select **Account Preferences**.
...
1. You are returned to your Sauce Labs Mobile App Distribution page with the `URL` and `Events` already filled in and selected.
...
1. Open your Sauce Labs Mobile App Distribution Preferences, go to **Integrations** and click **Add integration** next to WEBHOOK.
   <img src={useBaseUrl('/img/testfairy/integrations/slack/account-settings-4.png')} alt="Add integration"/>
