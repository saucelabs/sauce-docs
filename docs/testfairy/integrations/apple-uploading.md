...
Sauce Labs Mobile App Distribution allows you to upload your production app directory to the Apple App Store.
...
:::caution
Sauce Labs Mobile App Distribution will not publish your app publically; it only uploads the build to the store. The app owner in Apple iTunesConnect must publish the app itself publically.
:::
