...
Sauce Labs Mobile App Distribution allows you to upload your production app directory to the Google Play Store.
...
:::caution
Sauce Labs Mobile App Distribution does not publish your app publically; it only uploads the build to the store in a draft state. The app owner in Google must publish the app itself publically.
:::
