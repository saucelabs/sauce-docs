...
1. On the Sauce Labs Mobile App Distribution dashboard, navigate to the **Preferences**.
...
4. Name the parameter `env.TESTFAIRY_API_KEY` and give it the value you copied from the Sauce Labs Mobile App Distribution preferences page, and Save.
...
For a complete list of available options, visit the [Sauce Labs Mobile App Distribution Upload API documentation](/testfairy/api-reference/upload-api).
