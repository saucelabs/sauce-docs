    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Your API application key. See
                    https://app.testfairy.com/settings for details.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Android Package Kit (APK), Android App Bundle (AAB), iOS
                    package App Store (IPA), or ZIP (MacOS) file data.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Symbols mapping file. For iOS, this is a path to the{' '}
                    <strong>zipped</strong> symbols file. For Android, this is
                    the path to the mappings.txt file
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Comma-separated list of tester groups that get permission to
                    download this app.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Send email to all users in 'groups'. It can be{' '}
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Release notes for this upload. This text adds to emails and
                    landing pages.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Allows to upgrade all users to the current version. It can
                    be <code>on</code> or <code>off</code>. Default is{' '}
                    <code>off</code>.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Set of comma-separated tags to be displayed and searched
                    upon.
                </p>
            </td>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>Name of the dashboard folder that contains this app</p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Landing page mode. It can be <code>open</code> or{' '}
                    <code>closed</code>. Default is <code>open</code>.
                </p>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    Upload file directly to Sauce Labs. It can be{' '}
                    <code>on</code> or <code>off</code>. Default is{' '}
                    <code>off</code>.
                </p>
            </td>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p>
                    In case the app is not iOS or Android, which are detected
                    automatically, use this to mark an app for specific desktop
                    or console platforms. Values can be "Xbox", "PlayStation",
                    "switch", "windows", "macos". This feature is not enabled by
                    default. Contact support for more information.
                </p>
            </td>
        </tr>
    </tbody>
