...
Webhooks allow integration between Sauce Labs Mobile App Distribution and your backend. Using these webhooks, you can subscribe for specific events and receive an HTTP POST request whenever such an event occurs.
...
Sauce Labs Mobile App Distribution automatically detects Slack endpoints and sends an appropriate payload. Follow the [Slack integration guide](/testfairy/integrations/slack).
