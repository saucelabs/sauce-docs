...
<details>
<summary><span className="api get">GET</span><code>/api/1/audits?type=tester_trail</code></summary>
<p></p>
...
<table id="table-api">
	<tbody>
		<tr>
			<td><code>type</code></td>
			<td><code>tester_trail</code></td>
			<td>Required. Must be set to <code>tester_trail</code>.</td>
		</tr>
		<tr>
			<td><code>site</code></td>
			<td><code>string</code> or <code>int</code></td>
