...
To distribute Lumberyard Apps to Sauce Labs Mobile App Distribution, follow the steps provided in this guide.
...
## Uploading To Sauce Labs Mobile App Distribution
...
Optionally, you can download and use [Sauce Labs Mobile App Distribution command line uploader](https://github.com/testfairy/command-line-uploader) if you don't have **curl** installed.
