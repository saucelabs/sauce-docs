...
Adding the Sauce Labs Mobile App Distribution plugin to your Cordova or Phonegap project is simple.
...
Initialize Sauce Labs Mobile App Distribution with your [App Token](https://app.testfairy.com/settings/#apptoken) by calling `TestFairy.begin`. Your **APP TOKEN** is available at `https://app.testfairy.com/settings/#apptoken`.
...
We recommended logging error events to Sauce Labs Mobile App Distribution. It displays the exceptions and the rest of the session data, including logs and attributes. For more information, see the Exception Logging /testfairy/sdk/logging#cordova document.
...
This error happens when you export your iOS app to the App Store. The App Store only supports apps built for the ARM architecture. To allow developers to test in the iOS Simulator, Sauce Labs Mobile App Distribution includes the architectures for 64-bit (x86_64) and 32-bit (i386) Intel architectures.
...
Congratulations, you've successfully integrated Sauce Labs Mobile App Distribution into your Cordova project! Visit your [dashboard](http://app.testfairy.com/), to see your app listed.

- Have a look at the [API documentation](https://github.com/testfairy/testfairy-cordova-plugin/blob/master/www/testfairy.js) for other calls you can make to the Sauce Labs Mobile App Distribution plugin
