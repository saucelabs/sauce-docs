...
To add the Sauce Labs Mobile App Distribution plugin to your Ioic 3 project, follow the instructions below.
...
// Declare the Sauce Labs Mobile App Distribution instance
...
Congratulations. You've successfully integrated Sauce Labs Mobile App Distribution into your Ionic project. Visit your [dashboard](http://app.testfairy.com/), to see your app listed.

- Look at the [API documentation](https://github.com/testfairy/testfairy-cordova-plugin/blob/master/www/testfairy.js) for other calls to the Sauce Labs Mobile App Distribution plugin.
