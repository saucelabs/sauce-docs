...
<img
    src={useBaseUrl('img/visual/component-review-button.png')}
    alt='Component Review Button'
/>
...
<img
    src={useBaseUrl('img/visual/component-review-state.jpeg')}
    alt='Component Review State'
/>
...
<img
    src={useBaseUrl('img/visual/component-review-screenshots.jpeg')}
    alt='Component Review Screenshot'
/>
...
<img
    src={useBaseUrl('img/visual/component-review-accept.png')}
    alt='Component Review Accept'
    width='200px'
/>
...
<img
    src={useBaseUrl('img/visual/component-review-next.png')}
    alt='Component Review Next'
/>
...
<img
    src={useBaseUrl('img/visual/component-review-complete.png')}
    alt='Component Review Complete'
/>
...
-   An object with `deviceName` and optional `deviceOrientation` properties.
    ...
    <details>
        <summary>
            Supported <code>deviceName</code> value options (
            <strong>click here to expand</strong>):
        </summary>
        <ul>
            <li>iPad</li>
            <li>iPad Pro</li>
