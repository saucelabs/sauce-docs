...
Follow the steps below to integrate Visual E2E Testing into your Selenium WebDriver tests, using the language/library of your choice. You can use any programming language that Selenium WebDriver supports without needing to install additional libraries or SDKs.
...
## Integrate Visual E2E Testing with WebDriver

To integrate Visual E2E with your existing Selenium WebDriver test scripts:
...
If you've never used WebDriver, here's how to run a Visual E2E test using sample WebDriver tests.
