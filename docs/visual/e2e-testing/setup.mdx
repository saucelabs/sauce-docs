...
<details>
    <summary>
        Click <strong>Show Logs</strong> >{' '}
        <strong>View Logs on Sauce Labs</strong> to see your{' '}
        <a href='/test-results'>test results</a> on Sauce Labs.
    </summary>
    <img
        src={useBaseUrl('img/visual/e2e-quickstart-view-logs.png')}
        alt='Visual E2E Quickstart accept state'
        width='205'
    />
    <br />
    <img
        src={useBaseUrl('img/visual/e2e-quickstart-view-on-sauce.png')}
        alt='Visual E2E Quickstart accept state'
        width='250'
    />
</details>
