...
sidebar_label: React
description: Use React in your Backtrace project.
---
...
| `name`                              | String                                              | Your application name                                                                                                                                                                                                                                                                                                                                                                |         | <input type="checkbox" disabled="true" checked="true"/> |
| `version`                           | String                                              | Your application version                                                                                                                                                                                                                                                                                                                                                             |         | <input type="checkbox" disabled="true" checked="true"/> |
