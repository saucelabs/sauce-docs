...
:::note
While the functionality that’s currently available for tests run in this region is limited, you also have access to the US West region as part of this trial license; for details see [Supported Features](https://docs.saucelabs.com/docs/basics/data-center-endpoints/aust-early-access#SupportedFeatures).
:::
...
1. To verify you have access to the new region, **APAC-SOUTHEAST-1**, in Sauce Labs click the data centers dropdown.

<img src={useBaseUrl('img/aust-early-access.png')} alt="APAC-SOUTHEAST-1 availability" width="400"/>

2. To run your automated tests, update your Selenium tests to point to the new region by changin]
g the ondemand url during driver creation to `https://ondemand.apac-southeast-1.saucelabs.com`.

<img src={useBaseUrl('img/data-center-selenium.png')} alt="Update your Selenium tests" width="400"/>

3. To verify the results, log in to Sauce Labs and selec the **APAC-SOUTHEAST-1** region.
...
To tell us more about features that are most important to improve your experience with Sauce Labs, please [provide feedback](https://docs.saucelabs.com/docs/basics/data-center-endpoints/aust-early-access#GettingHelpandProvidingFeedback).
...
By participating in this program and providing feedback, we can prioritize OS and browser support in the best way possible! Please [provide feedback](https://docs.saucelabs.com/docs/basics/data-center-endpoints/aust-early-access#GettingHelpandProvidingFeedback).
