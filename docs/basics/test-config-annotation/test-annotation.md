...
| `"sauce:context=This line appears in the command list as 'info'"` <small><span className="sauceDBlue">RDC ✓</span></small> | Logs the given line in the job’s Selenium commands list.                                                                                                                                                                                   |
