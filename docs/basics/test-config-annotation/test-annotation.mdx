...
<img
    src={useBaseUrl('img/test-config-js-context1.png')}
    alt='Context for Selenium commands - before'
    width='250'
/>
<img
    src={useBaseUrl('img/test-config-js-context2.png')}
    alt='Context for Selenium commands - after'
    width='250'
/>
...
<p>
    <span className='sauceGreen'>Virtual Devices Only</span>
</p>
