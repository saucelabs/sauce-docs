...
<table>
    ...
    <tr>
        ...
        <td>
            Unsupported OSes may still be able to run Sauce Connect, but they've
            not been tested for versions 4.8.x and higher.
        </td>
    </tr>
    <tr>
        <td>macOS</td>
...
<table>
    <tr>
        ...
        <td>
            <strong>Recommended SC Tunnels</strong>
        </td>
    </tr>
    <tr>
        <td>0-59</td>
...
<img
    src={useBaseUrl('img/sauce-connect/dc-ui.png')}
    alt='Sauce Connect data center'
    width='450'
/>
