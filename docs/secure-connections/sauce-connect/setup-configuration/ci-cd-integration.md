...
* [Installing and Configuring the Sauce Labs Plugin for Bamboo](/integrations/bamboo)
...
For instructions on running your Jenkins build with Sauce Connect Proxy enabled, see [Sauce Labs with Jenkins](/integrations/jenkins).
