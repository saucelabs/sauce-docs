...
* Sauce Connect Proxy outbound connections to:
  ...
  * ht<span>tps://</span>google.com
* Connectivity to these Sauce Labs REST API calls:
  * ht<span>tps://</span>saucelabs.com/version.json
  * ht<span>tps://</span>saucelabs.com/rest/v1/[Your Sauce Username]/tunnels
...
![Correct network configuration](static/img/sauce-connect/correct-network-config.png)
...
![Dysfunctional geographic domain configuration](static/img/sauce-connect/dys-geo-config.png)
...
![Dysfunctional DMZ + SUT network configuration](static/img/sauce-connect/dys-dmz-config.png)
