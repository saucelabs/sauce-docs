...
```bash
curl -L -o sauce-connect.deb https://saucelabs.com/downloads/sauce-connect/5.5.3/sauce-connect_5.5.3.linux_amd64.deb
sudo dpkg -i sauce-connect.deb
```
...
```bash
sudo rpm -i https://saucelabs.com/downloads/sauce-connect/5.5.3/sauce-connect-5.5.3_linux.x86_64.rpm
```
...
```bash
curl -L -o sauce-connect.tar.gz https://saucelabs.com/downloads/sauce-connect/5.5.3/sauce-connect-5.5.3_linux.x86_64.tar.gz
sudo mkdir -p /opt/sauce-connect
sudo tar -C /opt/sauce-connect -xzf sauce-connect.tar.gz
```
