...
There are generally two ways to generate tests from a spec file:

* [generate a single test file](#generate-a-single-test-from-a-spec-file)
* [mass generate tests files](#mass-generate-tests-from-a-spec-file).

## Generate a Single Test From a Spec File
  
This feature allows you to create a test starting with a specification file.From the project home page:

Choose the __Import Tests__ button.

<img src={useBaseUrl('img/api-fortress/2021/02/importTests.png')} alt="Import Tests Button"/>
